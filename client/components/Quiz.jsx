...
const tryAgain =
  'pt-12 text-2xl md:text-3xl lg:text-4xl text-greenMid transition ease-out duration-500 hover:text-textWhite'

const quizReport = 'pt-12 text-3xl md:text-4xl lg:text-5xl text-textWhite'
